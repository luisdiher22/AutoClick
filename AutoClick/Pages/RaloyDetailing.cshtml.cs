...
{
    public class RaloyDetailingModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            try
            {
                ...
                // 3. Notificaría al equipo de Raloy Detailing
                
                // Mensaje personalizado para Raloy
                var serviciosTexto = ServicioInteres.Select(s => s.Replace("-", " ")).ToList();
                var serviciosFormateados = string.Join(", ", serviciosTexto);
                
                SuccessMessage = $"¡Gracias {Nombre}! Hemos recibido su solicitud de cotización para {serviciosFormateados}. " +
                               $"El equipo de Raloy Detailing se pondrá en contacto con usted en las próximas 24 horas al {Telefono} " +
                               "para coordinar una cita y brindarle una cotización personalizada.";
